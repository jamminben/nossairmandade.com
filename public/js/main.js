...
function windowLoadInit() {
    ...
    jQuery('.feedback').on('submit', function( e ) {
        ...
        $form.find('.feedback_response').html('<span><i class="fas fa-ellipsis-h"></i></span>');
        // Prepare query string and send AJAX request
        jQuery.ajax({
            url: '/submit-feedback',
            data: 'ajax=true&message=' + escape($form.find('.feedback_message').val()) + '&entityType=' + escape($form.find('.entity_type').val()) + '&entityId=' + escape($form.find('.entity_id').val()) + '&userId=' + escape($form.find('.user_id').val()),
            success: function(msg) {
                $form.find('.feedback_response').html(msg);
            }
        });
    });
