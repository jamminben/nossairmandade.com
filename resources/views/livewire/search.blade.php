            ...
            <div class="row">
                ...
                <div class="inline-block bottompadding_20">
                    <div class="hymn-list-name">
                        <a href="{{ !is_null($hymnTranslation->hymn) ? url( $hymnTranslation->hymn->getSlug()) : null }}">{{ mb_convert_case($hymnTranslation->name, MB_CASE_TITLE, "UTF-8") }}</a>
                    </div>
                    <p>
                        {{ !is_null($hymnTranslation->hymn) ?$hymnTranslation->hymn->receivedBy->display_name : null }}
